...
import sys
sys.path.append('/data/users/wen/visilens_castor')
...
#data = vl.read_visdata('CLASS_B1422+231_cal_timebin6.bin')
# Follow Ext_fit_line_SPT0345-52_CO21.py to combine two datasets
datasets = []
...
lens = [
    vl.SIELens(z=0.34,
    x={'value':-0.3896,'fixed':True,'prior':[-1.5,0.5]},
    y={'value':-0.2404,'fixed':True,'prior':[-1.,1.]},
    M={'value':9.3565e10,'fixed':True,'prior':[1e9,1e13]},
    e={'value':0.16,'fixed':True,'prior':[0.,0.8]},
    PA={'value':123.0,'fixed':True,'prior':[0,180]}),
    
    vl.ExternalShear(
        shear={'value':0.22,'fixed':True,'prior':[0.,0.5]},
        shearangle={'value':126.0,'fixed':True,'prior':[0.,180.]})]
...
source = [
    ...
    xoff={'value':0.301,'prior':[0.1,0.4]},
    yoff={'value':0.123,'prior':[0.0,0.3]},
    flux={'value':7.18e-4,'prior':[0.,0.100]}, # 5 mJy
    majax={'value':0.02,'prior':[0.,0.5]},
    index={'value':0.88,'prior':[0.3,2.5]},
    axisratio={'value':0.70,'prior':[0.3,1.]},
    PA={'value':43.77,'prior':[0.,180]})]
